...
const userVerificationTemplate = ({ first_name, otp }: Params) => {
  return `<!DOCTYPE html>
<html
  lang="en"
  style="
...
>
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <title>Gadget Store - Email Verification</title>
  </head>
  <body
    style="
      margin: 0;
    ...
    1
                ...
                >
                  ...
                  <strong
                    ...
                    >${otp}</strong
                  >.
                    Use it to verify your account and complete your registration.
                </p>
                <br
                  style="
                    margin: 0;
